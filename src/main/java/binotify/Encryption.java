...
public class Encryption {
    ...
    public static String encryptPasswordBasedECB(String plainText, SecretKey key)
            throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException,
            InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
    ...
    public static String decryptPasswordBasedECB(String cipherText, SecretKey key)
            throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException,
            InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
        Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5PADDING");
    ...
    public boolean checkString_whenEncrypt_thenSuccess(String API_KEY)
            throws InvalidKeySpecException, NoSuchAlgorithmException,
            IllegalBlockSizeException, InvalidKeyException, BadPaddingException,
            InvalidAlgorithmParameterException, NoSuchPaddingException  {

        String plainText = "rest.tubes2wbd.2Dec";
        String password = "freakyfun";
        String salt = "kitabisa";
    ...
    public static void main(String[] args) {
        try {
            ...
            encryption.checkString_whenEncrypt_thenSuccess("aSjbPA5w9gmRiTojIsOR1As4nwip8Ry6gxCNX7bfdxw=");
